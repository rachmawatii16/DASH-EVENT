...
<div class="container mt-5">
    <div class="d-flex justify-content-center">
        <div class="card p-4" style="width: 600px;">
            ...
            <form action="{{ route('recruiter.updateProfile') }}" method="POST" enctype="multipart/form-data" id="profileForm">
                @csrf
                @method('PUT')
                ...
                <div class="form-group mb-3">
                    <label for="company_name">Organization/Instance</label>
            ...
            <form action="{{ route('recruiter.updatePassword') }}" method="POST" id="passwordForm" style="display: none;">
                @csrf
                @method('PUT')
            </form>
        </div>
